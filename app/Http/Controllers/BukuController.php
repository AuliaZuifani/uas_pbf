...
class BukuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->withErrors(['error' => 'Gagal menambahkan data buku'])->withInput();
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->withErrors(['error' => 'Gagal mengupdate data buku'])->withInput();
    }
    ...
    public function destroy($id)
    {
        ...
        return back()->with('error', 'Gagal menghapus data buku.');
    }
}
